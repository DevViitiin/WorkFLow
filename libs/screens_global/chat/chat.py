...
class Chat(MDScreen):
    ...
    def on_leave(self, *args):
        """Limpa a tela ao sair e cancela todas as operações agendadas"""
        ...
        # Limpa TODAS as verificações agendadas com Clock
        Clock.unschedule(self.event_state)
        Clock.unschedule(self.event_messages)

        # Remove o binding do scroll para evitar triggers ao sair
        try:
        ...
        print('✓ Limpeza completa ao sair - Todos os Clock.schedule cancelados')
