...
class AssesPunctuality(MDScreen):
    ...
    def update_component(self, indice):
        ...
        self.ids.asses.text = self.ASSESSMENT_LEVELS['punctuality'][indice]['text']
        self.ids.asses.text_color = get_color_from_hex(self.ASSESSMENT_LEVELS['punctuality'][indice]['color'])
