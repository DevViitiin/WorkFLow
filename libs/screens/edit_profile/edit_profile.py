...
class EditProfile(MDScreen):
    ...
    def check_and_request_permissions(self):
        ...
        if missing_permissions:
            ...
            Clock.schedule_one(lambda dt: self.show_error('Conceda as permissões necessarias'), 2)
            Clock.schedule_once(lambda dt: self.show_error('Para poder definir novas fotos de perfil'), 2)
