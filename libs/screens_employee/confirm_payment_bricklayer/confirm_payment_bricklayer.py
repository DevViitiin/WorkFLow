...
class ConfirmPaymentBricklayer(MDScreen):
    ...
    def on_enter(self):
        print('Pagamentos confirmados: ', self.confirm_payment)
        print('Vales dos funcionarios: ', self.valleys)
        self.verific_token()
        ...
        value = float(self.salary_gross)
        valor_formatado = format_currency(value, "BRL", locale="pt_BR")
    ...
    def upload_info(self):
        self.ids.remainder.text = str(self.value_salary)
        self.ids.days.text = str(self.days)
        self.ids.month.text = str(self.time)
        self.ids.name.text = str(self.name_employee)
        value = float(self.salary_gross)
        valor_formatado = format_currency(value, "BRL", locale="pt_BR")
        self.ids.gross_salary = f"{valor_formatado}"
    ...
    def confirm_payment_bricklayer(self):
        ...
        data = {
            'data': f"{self.time}",
            'value': f'{valor}',
            'salary_completed': f'{self.salary_gross}',
            'numb': self.numb,
            'who': 'contractor',
            'Month': f'{self.month}',
