...
class RequestsVacancy(MDScreen):
    ...
    def on_enter(self, *args):
        ...
        print('Local iddd: ', self.local_id)
        """
        ...
        try:
            ...
            if not self.contractor:
                ...
                if not self.request:
                    ...
                    request_sent.token_id = self.token_id
                    request_sent.api_key = self.api_key
                    request_sent.local_id = self.local_id
                    request_sent.refresh_token = self.refresh_token
                ...
                review.token_id = self.token_id
                review.local_id = self.local_id
                review.refresh_token = self.refresh_token
                review.api_key = self.api_key
