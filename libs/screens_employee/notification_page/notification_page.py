...
from kivy.properties import NumericProperty, StringProperty, Clock, get_color_from_hex
...
class NotificationPage(MDScreen):
    ...
    def navigate_to_review_screen(self, *args):
        """
    ...
    def finalize_payment(self, req, result, *args):
        """
