...
from libs.components.test.test import Test1
...
class MainApp(MDApp):
    ...
    def build(self):
        ...
        self.screenmanager.add_widget(Test1(name='test'))
    ...
    def load_all_kv_files(self):
        Builder.load_file('libs/components/test/test.kv')
        ...
        Builder.load_file('libs/screens/add_employee_password/add_employee_password.kv')
